...
class camera {
    ...
    private:
        ...
        vec3 defocus_disk_u;        // Defocus horizontal radius
        vec3 defocus_disk_v;        // Defocus vertical radius
        ...
        ray get_ray(int i, int j) const {
            ...
            // Construct camera ray originating from the defocus disk and directed at a random sampled point around pixel i, j
